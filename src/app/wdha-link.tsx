...
export function WdhaLink() {
    // return a message saying the form is closed if the date is past 15th of january 2026 23:59 CEST
    const isFormClosed = new Date() > new Date("2027-01-15T23:59:59+02:00");
    if (isFormClosed) {
